...
urlpatterns = [
    ...
    path('post/<slug:slug>/publish/',
         views.PublishPostView.as_view(), name='publish-post'),
    ...
    path('drafts/author/', views.DraftPostAuthorListView.as_view(),
         name='draft-post-author-list'),
