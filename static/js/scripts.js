...
document.addEventListener('DOMContentLoaded', function() {
    // Get references to HTML elements
    var postContainer = document.getElementById('postContainer2');
    var postCards = postContainer.getElementsByClassName('extrapost2');
    var showMoreLink = document.getElementById('showMoreLink2');
